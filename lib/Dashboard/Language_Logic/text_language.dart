...
class TextLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.text.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.text.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.text.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.text.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
