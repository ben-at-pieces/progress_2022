...
class RubyLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.ruby.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.ruby.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.ruby.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.ruby.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
