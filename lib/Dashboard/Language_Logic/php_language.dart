...
class PHPLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.php.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.php.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.php.elementAt(index).name}' ?? ''),
                  subtitle: Text('${StatisticsSingleton().statistics?.php.elementAt(index).description}' ?? ''),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
