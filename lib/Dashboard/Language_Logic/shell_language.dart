...
class ShellLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.shell.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.shell.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.shell.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.shell.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
