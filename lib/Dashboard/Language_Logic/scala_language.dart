...
class ScalaLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.scala.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.scala.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.scala.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.scala.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
