...
class LuaLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.lua.length;
    ...
    if (count == 0) {
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.lua.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.lua.elementAt(index).name}' ?? ''),
                  subtitle: Text('${StatisticsSingleton().statistics?.lua.elementAt(index).description}' ?? ''),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
