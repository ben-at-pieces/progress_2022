...
class CLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.c.length;
    if (count == 0) {
      return Card(
        child: Column(
          children: [
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.c.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.c.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.c.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
