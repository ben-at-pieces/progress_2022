...
class SQLLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.sql.length;
            ...
            Padding(
              ...
              child: ListTile(
                ...
                leading: TextButton(
                  ...
                  onPressed: () async {
                    String linkUrl =
                        'https://code.pieces.app/collections/sql?os=C67CACB2-1171-48D6-88F4-3363FC54E34C%0A&user=db21f9b1-f7a4-45ba-82c4-5f029e9177d0';
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.sql.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.sql.elementAt(index).name}' ?? ''),
                  subtitle: Text('${StatisticsSingleton().statistics?.sql.elementAt(index).description}' ?? ''),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
