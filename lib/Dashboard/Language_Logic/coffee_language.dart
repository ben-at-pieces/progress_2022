...
class CoffeeLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.coffee.length;
    ...
    if (count == 0) {
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.coffee.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.coffee.elementAt(index).name}' ?? ''),
                  subtitle: Text('${StatisticsSingleton().statistics?.coffee.elementAt(index).description}' ?? ''),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
