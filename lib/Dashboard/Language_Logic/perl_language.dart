...
class PerlLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.perl.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.perl.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.perl.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
