...
class JSONLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.json.length;
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: Text('${StatisticsSingleton().statistics?.json.elementAt(index).description}' ?? ''),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
