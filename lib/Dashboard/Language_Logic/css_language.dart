...
class CSSLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.css.length;
    ...
    if (count == 0) {
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.css.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.css.elementAt(index).name}' ?? ''),
                  subtitle: Text('${StatisticsSingleton().statistics?.css.elementAt(index).description}' ?? ''),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
