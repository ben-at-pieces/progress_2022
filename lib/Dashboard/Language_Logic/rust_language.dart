...
class RustLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.rust.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.rust.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.rust.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.rust.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
