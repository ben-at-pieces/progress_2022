...
class TOMLLanguageBuilder extends StatelessWidget {
  final String title;
  ...
  @override
  Widget build(BuildContext context) {
    int? count = StatisticsSingleton().statistics?.toml.length;
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: StatisticsSingleton().statistics?.toml.length,
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  title: Text('${StatisticsSingleton().statistics?.toml.elementAt(index).name}'),
                  subtitle: Text('${StatisticsSingleton().statistics?.toml.elementAt(index).description}'),
                  trailing: Icon(Icons.copy),
                ),
              ],
            ),
