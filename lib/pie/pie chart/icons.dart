...
class _ExpandableIconState extends State<ExpandableIcon> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final Animation<double> hamburgerCurve =
        CurvedAnimation(parent: _hamburgerAnimationController, curve: Curves.easeOutQuart);
    ...
    final Animation<double> arrowCurve =
        CurvedAnimation(parent: _arrowAnimationController, curve: Curves.easeOutQuart);
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final line1Point1 = Offset(
        ...
        ((((iconHeight * 0.35) + (((((iconHeight * .32) / 2))) * hamburgerProgress)))) -
    ...
    final line2Point1 = Offset(
        (iconWidth * .27) + ((iconWidth * .27) * arrowProgress),
        (((iconHeight * 0.65) - (((((iconHeight * .32) / 2))) * hamburgerProgress))) +
            ((iconHeight * 0.20) * arrowProgress));
