...
import 'package:gsheets/tabs/pie%20chart%20Saved/saved_colors.dart';
import 'package:gsheets/tabs/pie%20chart%20Saved/saved_dataMap.dart';
...
class SavedPie extends StatelessWidget {
  const SavedPie({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        PieChart(
          ...
          colorList: saved_colorList,
          chartType: ChartType.ring,
          centerText: true ? '${dataMap2.values} TOTAL' : null,
